...
import com.twa.flights.api.provider.beta.controller.documentation.ProviderResources;
import com.twa.flights.api.provider.beta.service.ProviderService;
import com.twa.flights.api.provider.beta.validator.AvailabilityRequestValidator;
...
public class ProviderController implements ProviderResources {
    ...
    public ResponseEntity<List<ItineraryDTO>> availability(AvailabilityRequestDTO request) {
        LOGGER.debug("Obtain all the itineraries from provider beta");
