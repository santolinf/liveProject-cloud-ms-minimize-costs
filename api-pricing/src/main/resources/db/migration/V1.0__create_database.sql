create table commercial_policy (id bigint not null, active boolean not null, expire_date timestamp, name varchar(50) not null, priority integer not null, start_date timestamp not null, primary key (id));
